      ...
      <section className="relative min-h-screen flex items-center px-10 lg:px-44 py-24 bg-black mx-auto">
        <div style={{ margin: "0 auto " }}
          ...
          <div className="space-y-6 lg:space-y-8 text-left max-w-lg">
            ...
            <div className="text-[#8a8a8a] text-sm md:text-base lg:text-lg leading-relaxed max-w-md text-justify">
              <p>
                I am Nithesh Kumar, a specialist in AI and Data Analytics with a passion for frontend development. I don't just build websites; I create custom digital experiences designed to convert visitors into customers. By leveraging tools like Figma and technologies like React, I simplify the design process so you can focus on growing your brand.
              </p>
            </div>
